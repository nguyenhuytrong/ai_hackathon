    ...
    async function fetchReport() {
      try {
        const res = await fetch(`${BACKEND}/generate-report`, {
          ...
          body: JSON.stringify({ cms: cmsResult, raw: report }),
        });
    ...
    <div className="report-page">
      ...
      <main className="report-main">
          ...
          <section className="report-section">
            ...
            {error && (
              <p className="ai-error">
                Could not generate summary. Check backend connection.<br />
            ...
            {aiData && (
              <>
                ...
                <div className="flags-block">
                  ...
                  <ul>
                    {aiData.clinical_flags.map((f, i) => <li key={i}>{f}</li>)}
                  </ul>
                </div>
                ...
                <div className="flags-block next-steps" style={{ marginTop: 14 }}>
                  ...
                  <ul>
                    {aiData.next_steps.map((s, i) => <li key={i}>{s}</li>)}
                  </ul>
                </div>
              </>
            )}
        ...
        <section className="report-section sources-section">
          <h2>Evidence &amp; Clinical Sources</h2>
